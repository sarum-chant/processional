...
\label{006411-descendit-de-celis}
...
\gregorioscore{007575-sancte-dei-preciose}

\emph{Tres diaconi dicant simul hunc ℣.}

\begin{noinitial}

\gregorioscore{007575a-ut-tuo-propiciatus}
...
\gregorioscore{007575-gloria-patri}

\emph{In redeundo ant.} Hódie Christus natus. \pageref{003093-hodie-christus}.

\emph{℣.} Benedíctus qui venit. 23.

\emph{Oratio.} Concéde quésumus omnípotens Deus. 23.

\emph{Simili modo de sancto Johanne et de Innocentibus et de sancto Thoma si in dominica festum illorum evenerit cum ix. ℟. et ℣. et prosa, et} Glória Patri. \emph{et semper in redeundo usque ad circumcisionem dicatur antiphona} Hódie Christus. \emph{cum ℣. et oratione ut supra.} \pageref{003093-hodie-christus}.
...
\emph{In introitu chori antiphona.} Hódie Christus. \pageref{003093-hodie-christus}.
...
\gregorioscore{f16-spiritus-sanctus}

\emph{⟨Chorus respondeat sic.⟩\footnote{1519:78r.}}

⟨\gregorioscore{f16v-amen}⟩\footnote{1519:77v; 1531:37v.}
...
\emph{Si dominica fuerit ad processionem ℟.} Descéndit. \pageref{006411-descendit-de-celis}. \emph{℣.} Tanquam sponsus. \emph{et dicitur sic.}

\gregorioscore{006411a-tanquam-sponsus-f18r}

\emph{\&c.~sine prosa cum} Glória Patri.\footnote{`\emph{vel ℟.} Verbum caro. \emph{℣.} In princípio. \emph{sine prosa}', GS:18.} \pageref{006411a-tanquam-sponsus}.

\emph{¶ In redeundo de nativitate ut supra.\footnote{`\emph{In redeundo} Te laudant. \emph{vel} Hódie Christus. \emph{Sequatur ℣. et or. de nat.}' GS:18.}} \pageref{003093-hodie-christus}.
