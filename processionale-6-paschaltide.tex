...
\emph{Qua finita rectores ex parte chori incipiant psalmum sequentem sic.\footnote{`\emph{hoc modo}', 1882:94.}} \gregorioscore{missing}
...
\grecommentary{Rylands-24:231; 1519:111r}

\gabcsnippet{(c4) Ky(gv)ri(gv)e(gv)léy(ji~)son(jv) qui(jv) pre(jv)ci(jv)ó(ji)so(h) sán(jv)gui(jv)ne(jv) mun(ji~)dum(h) e(ij)ri(h)pu(h)ís(g)ti(g) de(g) ma(g)le(gh)díc(hggv)ti(f) fau(hg~)ce(hv) dra(ijhv)có(h)nis.(g) (::)}
...
\gabcsnippet{(c4) Sanc(gv)ta(gv) Ma(e)rí(fe)a(d) qué(fv)su(e)mus(fv) al(dc~)mum(dv) pós(gv)ce(gv)re(gh) re(ggv)gem(d) ju(fv)re(e) me(fv)mén(dc~)to(d) sal(gv)vet(gv) ut(gh) om(hggv)nes(f) nos(hg) ju(hvhv)bi(ij)lán(h)tes.(g) (::)}

\emph{Chorus} Kýrie\emph{.}

\emph{Clerici ⟨cantent versum⟩}.\footnote{1882:118.}

\gabcsnippet{(c4) Sanc(gv)te(gv) Mí(e)cha(fe)el,(d) qué(fv)su(e)mus(fv) al(dc~)mum.(dv) (::)}

\emph{Chorus} Kýrie\emph{.}

\emph{Clerici ⟨dicant versum⟩.\footnote{1882:118.}}

\gabcsnippet{(c4) Om(gv)nis(gv) cho(gv)rus(gv) an(gv)ge(gv)ló(gv)rum(gv) et(gv) arch(gv)an(gv)ge(e)ló(fe)rum(d) qué(fv)su(e)mus(fv) al(dc~)mum.(dv) (::)}
...
\grecommentary{Rylands-24:232; 1519:111v.\footnote{1519:111v. has no flats. 1554:117v. has some of the flats. In 1519:111r. `Christeléyson' is set A.AGF.G.DC. Some printed processionals have:

  \gregorioscore{missing}}}

\gabcsnippet{(c4) Ky(dv)ri(dh)e(hvGF)léy(gh~)son.(hv) (::)
Chris(hv)te(hvGF)léy(gf~)son.(dc) (::)
Chris(fg)te(dfED) au(dc~)di(cd) nos.(dv) (::)}
...
\gabcsnippet{(c4) Pa(d)ter(d) de(d) ce(d)lis(d) De(fv)us(d) mi(d)se(dc)ré(fv)re(gh) no(ixhih)bis.(h) (::)}

\emph{⟨Item⟩\footnote{1882:118.} chorus ⟨repetat⟩\footnote{1882:118.}} Kýrie. \emph{⟨et cetera⟩.\footnote{1882:118.}}

\emph{Clerici ⟨cantent versum⟩.\footnote{1882:118.}} 

\gabcsnippet{(c4) Fi(d)li(d) re(d)démp(d)tor(d) mun(d)di(d) De(fv)us(d) mi(d)se(dc)ré(fv)re(gh) no(ixhih)bis.(h) (::)}

\emph{⟨Iterum⟩\footnote{1882:118.} chorus ⟨repetat⟩\footnote{1882:118.}} Kýrie.

\emph{Clerici ⟨cantent versum⟩.\footnote{1882:118.}}

\gabcsnippet{(c4) Spí(d)ri(d)tus(d) Sanc(d)te(d) De(fv)us(d) mi(d)se(dc)ré(fv)re(gh) no(ixhih)bis.(h) (::)
}
...
\gabcsnippet{(c4) Sanc(d)ta(d) Trí(d)ni(d)tas(d) u(d)nus(d) De(fv)us(d) mi(d)se(dc)ré(fv)re(gh) no(ixhih)bis.(h) (::)}

\emph{Chorus ⟨repetat⟩\footnote{1882:118.}} Kýrie.

\emph{⟨Postea⟩\footnote{1882:118.} clerici ⟨dicant versum⟩.\footnote{1882:118.}}

\gabcsnippet{(c4) Sanc(d)ta(d) Ma(d)rí(fv)a(d) o(dc)ra(fv) pro(gh) no(ixhih)bis.(h) (::)}
...
\gabcsnippet{(c4) Sanc(d)ta(d) De(d)i(d) gé(fv)ni(d)trix(d) o(dc)ra(fv) pro(gh) no(ixhih)bis.(h) (::)}

\emph{⟨Item⟩\footnote{1882:118.} chorus} Kýrie.

\emph{⟨Postea⟩\footnote{1882:119.} clerici ⟨dicant versum⟩.\footnote{1882:119.}}

\gabcsnippet{(c4) Sanc(d)ta(d) vir(d)go(d) vír(fv)gi(d)num(d) o(dc)ra(fv) pro(gh) no(ixhih)bis.(h) (::)}

\emph{⟨Iterum⟩\footnote{1882:119.} chorus} Kýrie.

\emph{⟨Postea⟩\footnote{1882:119.} clerici ⟨dicant versum⟩.\footnote{1882:119.}}

\gabcsnippet{(c4) Sanc(d)ta(d) Mí(fv)cha(d)el(d) o(dc)ra(fv) pro(gh) no(ixhih)bis.(h) (::)}
...
\gabcsnippet{(c4) Sanc(d)ta(d) Gá(fv)bri(d)el(d) o(dc)ra(fv) no(ixhih)pro(gh) bis.(h) (::)}

\emph{⟨Item⟩\footnote{1882:119.} chorus ⟨repetat⟩\footnote{1882:119.}} Kýrie.

\emph{⟨Postea⟩\footnote{1882:119.} clerici ⟨dicant versum⟩.\footnote{1882:119.}}

\gabcsnippet{(c4) Sanc(d)ta(d) Rá(fv)pha(d)el(d) o(dc)ra(fv) no(ixhih)pro(gh) bis.(h) (::)}

\emph{⟨Item⟩\footnote{1882:119.} chorus ⟨repetat⟩\footnote{1882:119.}} Kýrie.

\emph{⟨Deinde⟩\footnote{1882:119.} clerici ⟨dicant versum⟩.\footnote{1882:119.}}

\gabcsnippet{(c4) Om(d)nes(d) sanc(d)ti(d) án(d)ge(d)li(d) et(d) arch(d)án(fv)ge(d)li(d) o(d)rá(dc)te(fv) pro(gh) no(ixhih)bis.(h) (::)}

\emph{⟨Deinde⟩\footnote{1882:119.} chorus ⟨repetat⟩\footnote{1882:119.}} Kýrie.

\emph{⟨Postea⟩\footnote{1882:119.} clerici ⟨dicant versum⟩.\footnote{1882:119.}}

\gabcsnippet{(c4) Om(d)nes(d) sanc(d)ti(d) be(d)a(d)tó(d)rum(d) spi(d)rí(d)tu(d)um(d) ór(fv)di(d)nes(d) o(d)rá(dc)te(fv) pro(gh) no(ixhih)bis.(h) (::)}

\emph{⟨Postea⟩\footnote{1882:119.} chorus ⟨repetat⟩\footnote{1882:119.}} Kýrie.

\emph{⟨Item⟩\footnote{1882:119.} clerici ⟨versum⟩.\footnote{1882:119.}}

\gabcsnippet{(c4) Sanc(d)te(d) Jo(d)hán(d)nes(d) bap(d)tís(fv)ta(d) o(dc)a(fv) pro(gh)
no(ixhih)bis.(h) (::)}
...
\gabcsnippet{(c4) Om(d)nes(d) sanc(d)ti(d) pa(d)tri(d)ár(d)che(d) et(d) pro(d)phé(fv)te(d) o(d)rá(dc)te(fv) pro(gh) no(ixhih)bis.(h) (::)}
...
\grecommentary{Rylands-24:232; 1519:112v}

\gabcsnippet{(c4) Ky(jv)ri(jv)e(jk)léy(ih~)son.(gh) (::)
Chris(ihi)te(jv)léy(hg~)son.(f) (::)
Chris(hg)te(hijv) au(ig)di(hg~) nos.(g) (::)}
...
\gabcsnippet{(c4) Sanc(jv)ta(jv) Ma(jk)rí(ih)a(gh) te(ihi) de(jv)pre(h)cá(gh)mur(f) o(hgjv)ra(hi) pro(ig) (::)
bis.(ghv) no(h)}
...
\gabcsnippet{(c4) Sanc(jv)te(jv) Mí(jk)cha(ih)el(gh) te(ihi) de(jv)pre(h)cá(gh)mur(f) o(hgjv)ra(hi) pro(ig) (::)
bis.(ghv) no(h)}
...
\gabcsnippet{(c4) Om(jv)nes(jv) sanc(jv)ti(jv) án(jv)ge(jv)li(jv) et(jv) arch(jk)án(i)ge(ih)li(gh) vos(ihi) de(jv)pre(h)cá(gh)mur(f) o(hv)rá(hg)te(hijv) pro(ig) no(hhv)bis.(g) (::)}
...
\section[¶ Quarto letania.]{¶ Quarto letania.\footnote{In 1508. this litany has the page heading `Letania in tempore belli.'}}

\grecommentary{Rylands-24:232; 1519:112v.\footnote{In some printed processionals `Kyrie' is set G.A.GFE; `Dómine' is set G.A.GFE.}}

\gabcsnippet{(c4) Ky(g)ri(hv)e(gvFD)léy(ghjv)son.(jv) (::)
Chris(ij)te(hvGF)léy(hg~)son.(g) (::)}
...
\gabcsnippet{(c4) Dó(g)mi(hv)ne(gvFD) mi(gv)se(hj)ré(ij)re(f) Chris(hi)te(h) mi(g)se(f)ré(gv)re.(gv) (::)}

\emph{Chorus idem ⟨repetat⟩.\footnote{1882:120.}}

\emph{⟨Postea⟩\footnote{1882:120.} clerici ⟨dicant versum⟩.\footnote{1882:120.}}

\gabcsnippet{(c4) Mi(g)se(g)ré(g)re(hv) no(g)bis(f) pi(hv)e(g) Rex(hj) Dó(ji)mi(hg)ne(gh) Je(ijh)su(g) Chris(fg)te.(gv) (::)}

\emph{Chorus idem ⟨repetat⟩.\footnote{1882:120.}}

\emph{⟨Postea⟩\footnote{1882:120.} clerici ⟨dicant versum⟩.\footnote{1882:120.}}

\gabcsnippet{(c4) Chris(ghiv)te(h) au(gf~)di(fg) nos.(gv) (::)}

\emph{Chorus} Kýrie.

\emph{⟨Item⟩\footnote{1882:120.} clerici.}

\gabcsnippet{(c4) Sanc(gv)ta(hj) Ma(jv)rí(jjh)a(h) o(hg)ra(f) pro(hv) no(hfg)bis.(gv) (::)}

\emph{Chorus ⟨repetat} Dómine⟩\footnote{1882:120.} miserére.

\emph{⟨Item⟩\footnote{1882:120.} clerici ⟨dicant versum⟩.\footnote{1882:120.}}

\gabcsnippet{(c4) Sanc(gv)ta(hj) De(jv)i(jvjv) gé(j)ni(h)trix(h) o(hg)ra(f) pro(hv) no(hfg)bis.(gv) (::)}

\emph{Chorus ⟨repetat⟩\footnote{1882:120.}} Miserére.

\emph{⟨Postea⟩\footnote{1882:120.} clerici ⟨dicant versum⟩.\footnote{1882:120.}}

\gabcsnippet{(c4) Sanc(gv)ta(hj) vir(jv)go(jvjv) vír(j)gi(h)num(h) o(hg)ra(f) pro(hv) no(hfg)bis.(gv) (::)}

\emph{Chorus ⟨repetat⟩\footnote{1882:120.}} Kýrie.

\emph{Clerici ⟨dicant versum⟩.\footnote{1882:120.}}

\gabcsnippet{(c4) Sanc(gv)te(hj) Mí(jjv)cha(h)el(h) o(hg)ra(f) pro(hv) no(hfg)bis.(gv) (::)}
...
\gabcsnippet{(c4) Om(gv)nes(hj) cho(jv)rus(jv) an(jv)ge(jv)ló(jv)rum(jv) et(jv) arch(jv)an(jv)ge(jv)ló(jh)rum(h) o(hg)ret(f) pro(hv) no(hfg)bis.(gv) (::)}

\emph{⟨Iterum⟩\footnote{1882:120.} chorus} Miserére.

\emph{Clerici ⟨dicant versum⟩.\footnote{1882:120.}}

\gabcsnippet{(c4) Sanc(gv)te(hj) Jo(jv)hán(jv)nes(jv) bap(jvjh)tís(j)ta(h) o(hg)ra(f) pro(hv) no(hfg) (::)
bis.(gv)}
...
\gabcsnippet{(c4) Om(gv)nis(hj) cho(jv)rus(jv) pa(jv)tri(jv)ar(jv)chá(jv)rum(jv) et(jv) pro(jv)phe(jv)tá(jjh)rum(h) o(hg)ret(f) pro(hv) no(hfg)bis.(gv) (::)}
...
\gabcsnippet{(c4) Ab(gv) i(ji)ni(jk)mí(ji)cis(hi) nos(hg)tris(f) de(hv)fén(hj)de(i) nos(hih) (::)
te.(g)}
...
\gabcsnippet{(c4) Chris(g)Af(g)flic(ji)ti(jk)ó(ji)nem(hi) nos(hg)tram(f) be(hj)níg(i)nus(hih) vi(g)de.(g) (::)}

\emph{Chorus idem ⟨repetat⟩.\footnote{1882:120.}}

\emph{Clerici ⟨versum⟩.\footnote{1882:120.}}

\gabcsnippet{(c4) Do(g)ló(ji)rem(jk) cor(ji)dis(hi) nos(hg)tri(f) rés(hj)pi(i)ce(hih) cle(g)mens.(g) (::)}

\emph{Chorus idem ⟨repetat⟩.\footnote{1882:120.}}

\emph{⟨Deinde⟩\footnote{1882:120.} clerici ⟨dicant versum⟩.\footnote{1882:120.}}

\gabcsnippet{(c4) Pec(g)cá(ji)ta(jk) pó(j)pu(ji)li(hi) tu(hg)i(f) pi(hj)us(i) in(hih)dúl(g)ge.(g) (::)}

\emph{Chorus idem ⟨repetat⟩.\footnote{1882:120.}}

\emph{⟨Iterim⟩\footnote{1882:120.} clerici ⟨dicant versum⟩.\footnote{1882:120.}}

\gabcsnippet{(c4) O(g)ra(ji)ti(jk)ó(ji)nes(hi) nos(hg)tras(f) pi(hj)us(i) ex(hih)áu(g)di.(g) (::)}

\emph{Chorus idem ⟨repetat⟩.\footnote{1882:120.}}

\emph{⟨Postea⟩\footnote{1882:120.} clerici ⟨dicant versum⟩.\footnote{1882:120.}}

\gabcsnippet{(c4) Fi(gji)li(jk) De(ji)i(hi) vi(hg)vi(f) mi(hv)se(hj)ré(i)re(hih) no(g)bis.(g) (::)}

\emph{Chorus idem ⟨repetat⟩}.\footnote{1882:120.}

\emph{⟨Deinde⟩\footnote{1882:120.} clerici ⟨dicant versum⟩}.\footnote{1882:120.}

\gabcsnippet{(c4) Hic(gijk) et(j) im(kl)per(k)pé(ji)tu(hj)um(jv) nos(jkji) cus(j)tó(hi)di(hg)re(f) dig(hj)né(i)ris(hih) Chris(g)te.(g) (::)}

\emph{Chorus idem ⟨repetat⟩}.\footnote{1882:120.}

\emph{⟨Iterum⟩\footnote{1882:121.} clerici ⟨dicant versum⟩}.\footnote{1882:121.}

\gabcsnippet{(c4) Ex(gijk)áu(j)di(kl) nos(k) Chris(ji)te(hj) ex(h)áu(hg)di,(f) ex(hv)áu(hj)di(i) nos(hih) Chris(g)te.(g) (::)}
