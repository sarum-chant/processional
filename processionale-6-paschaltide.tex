...
\emph{⟨Item⟩\footnote{1882:97.} pueri dicant sic ⟨ut sequitur⟩.}\footnote{1528:85v. At this point AS:239. includes a second verse:
  ...
  \gabcsnippet{(c4) Sit(hv) no(hv)men(gf~) Dó(hv)mi(jvhjgfh)ni(ev) be(hv)ne(hghfghg)díc(e)tum,(egfgffe) (,)
ex(d) hoc(fvfvfdgvFEdfhfgffvdfgef) (,)
nunc(fv) et(fv) us(fd)que(fv) in(fvfg) sé(evhv)cu(gfgEGfhhgfgevhdhgfgevhdGH)lum.(hj) (::)}
...
\gregorioscore{909041-kyrie-secunda-letania}
...
\gabcsnippet{(c4) Sanc(d)te(d) Jo(d)hán(d)nes(d) bap(d)tís(fv)ta(d) o(dc)ra(fv) pro(gh)
no(ixhih)bis.(h) (::)}
