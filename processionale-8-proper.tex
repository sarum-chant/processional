...
\emph{¶ Dominica vero infra octavas\footnote{`\emph{et in octava}, MS', 1882:135.} si dominica fuerit ad processionem Resp.} Terríbilis. 312. \emph{cum versu} Cumque evigilásset. \emph{ut supra et cum} Glória Patri. \emph{et ⟨cum⟩\footnote{1882:135.}} ‡~Et ego.\footnote{1882:135.
  ...
  \gabcsnippet{(c4) Gló(dh)ri(gh)a(gvFE) Pa(d)tri(fe) et(fg) Fí(fe)li(dceedfcdvhvhvGFgh)o:(hdfvfe) (;) et(d) Spi(fe)rí(fg)tu(fe)i(d) Sanc(ceedfcdvhjkvkvJIHgijvIFGgh~)to.(hvGFghd) (::) ‡~Et(dvCA) e(cdev)go.(d) (::)}} \emph{In paschali tempore cum} Allelúya.
...
\gregorioscore{004689-salvator-mundi}
...
\gregorioscore{006679-ex-ejus-tumba}

\emph{Cum suo ℣. sed sine prosa in hac processione.}

\begin{noinitial}

\gregorioscore{006679a-catervatim-ruunt}
...
\gregorioscore{005118-te-gloriosus}
...
\gregorioscore{006647-elegit-dominus}
...
\gregorioscore{006955-induit-me}
...
\gregorioscore{601878-preciosus-martyr-vincentius}
...
\gregorioscore{006272-celebremus-conversionem}
...
\gregorioscore{006278-christi-virgo}

\emph{⟨In introitu chori cantetur hec antiphona sequens:}

\gregorioscore{003340-ingressus-angelus}

\emph{Tempore paschali.}

\gregorioscore{003340-ingressus-angelus-tp}
...
% TODO: check that two 004018s are the same
...
\gregorioscore{007266-o-crux-gloriosa}
...
\gregorioscore{006979-inter-natos}
...
\gregorioscore{007503-quodcumque-ligaveris}
...
\gregorioscore{007582-sancte-paule}
...
\chapter[¶ Translatio sancti Thome martyris.]{¶ Translatio sancti Thome martyris.\footnote{In 1519:148v this procession is crossed out. In 1523. the folio is lacking.}}
...
\gregorioscore{006142-audi-filia}
...
\gregorioscore{007269-o-felix-sacrorum}
...
\gregorioscore{000000-beata-virgo-virginum}
...
\gregorioscore{007147-meruit-esse}
...
\gregorioscore{006725-felix-namque}

\emph{⟨℣.⟩} Glória Patri. 424. †~Quia ext te.

\emph{⟨Sequitur⟩\footnote{1882:154.} aliud responsorium.}

\gregorioscore{007726-super-salutem}

\emph{⟨℣.⟩} Glória Patri. 426. ‡~Consórtes et concíves.

\emph{In introitu chori dicatur ista antiphona.}

\grecommentary{1519:154r; AS:492; Ant-1520-S:91r; Brev-1531-S:105v.\footnote{In 1519:154r the final note of `immortalitátis' is the first note of `locum'.}}

\gregorioscore{200374-ascendit-christus}
...
\gregorioscore{006262-candida-virginitas}
