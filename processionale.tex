...
\newrubric \emph{¶ Item\footnote{`\emph{Deinde}', 1882:7.} conversus ad populum dicat sacerdos in lingua materna,} Orémus pro animábus \emph{N.} et \emph{N.\footnote{`Let us pray for the souls of \emph{N.} and \emph{N.}' trans. Ed.
...
\newrubric \emph{¶ Iste modus et ordo processionis servetur generaliter omnibus dominicis non duplicibus per {[}totum{]}\footnote{1882:9.} annum cum suis antiphonis vel responsoriis, cum oratione et ℣.}\footnote{`\emph{et versibus, et orationibus ipsis dominicis diversimode intitulatis.}' 1882:9.}
...
\gregorioscore{}{]}\footnote{Rylands-24:230.}
