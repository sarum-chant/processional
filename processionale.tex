...
\renewcommand\emph[1]{{\color{gregoriocolor}{#1}}}
...
\renewcommand{\LettrineTextFont}{\MakeUppercase} % make word following cap all caps
...
\renewcommand{\GreItalic}[1]{{\color{gregoriocolor}{#1}}} % use red for italics in scores
\grechangestyle{initial}{\woodcut\fontsize{90}{90}\selectfont}
\grechangestyle{commentary}{\footnotesize}
\grechangestyle{annotation}{\color{gregoriocolor}\footnotesize}
...
\newcommand\noinitial{\gresetinitiallines{0}\grechangestyle{firstsyllableinitial}{}}

\gresetheadercapture{cantus}{grecommentary}{}
...
\newenvironment{lesson}
    {\begin{multicols}{2}
    \renewcommand{\LettrineFontHook}{\lombardic\color{gregoriocolor}}
...
\author{edited by William Renwick\\with Andrew Dunning and Brandon Hawk}
...
\textit{Processionale ad vsum insignis ac preclare ecclesie Sarum nouiter castigatum per dominum episcopum de vuynton̄. feliciter incipit.} Par. venundātur Lond. apud F. byrckman (1519). STC 16235. The only surviving copy is Oxford, Bodleian Library, Gough Missals 75. Missing fol.~000.
...
\subsection[¶ Sequatur exorcismus aque ita incipiens.]{¶ Sequatur exorcismus aque ita incipiens.\footnote{`\emph{incipiendo}', 1882:2.}}
...
\emph{Hec preces predicta dicuntur supradicto modo omnibus dominicis per annum~: sive de dominica~: sive {[}de{]}\footnote{1882:8.} aliquo festo fit servitium~: nisi duplex festum fuerit~: et nisi in sexta die a nativitate Domini et in die sancti Silvestri si in dominica evenerit et nisi in dominica {[}in{]}\footnote{1882:8.} ramispalmarum.}
...
\emph{Ad processionem ant.} Missus est {[}ángelus{]}.\footnote{1882:9.} \emph{ut supra {[}in prima dominica adventus Domini{]}.\footnote{1882:9.}} 9.
...
\emph{Si dominica fuerit ad processionem ant.} Missus est. \emph{{[}et cetera{]}\footnote{1882:11.} ut supra {[}in dominica precedente{]}.}\footnote{1882:11.} 9.
...
\emph{In introitu chori a} \emph{circumcisione usque ad purificationem et si lxx. infra purificationem evenerit semper de sancta Maria dicatur {[}hoc{]}\footnote{1882:22.} ℟.} Te laudant ángeli. \emph{ut supra in {[}die{]}\footnote{1882:22.} circumcisionis} 43. \emph{excipiuntur cum\footnote{`\emph{tamen}', 1882:22.} dies epiphanie et dominica infra octavas ejusdem et in octava si {[}in{]}\footnote{1882:22.} dominica evenerit.}

\chapter{¶ In vigilia epiphanie.}

\emph{Si {[}in{]}\footnote{1882:22.} dominica evenerit ad processionem in eundo dicatur ℟.} Verbum caro. 41. \emph{cum ℣. et cum} Glória Patri. \emph{sed sine prosa}\textsc{.}
...
\emph{Non sequatur versiculus neque oratio~: sed sacerdos cum suis} \emph{ministris accedat, et statim a cantore incipiatur officium misse {[}et precedat crux lignea absque imagine crucifixi.{]}}\footnote{1882:41.}
...
\emph{Post singulos\footnote{'\emph{singulas'}, 1519:47v.} ℣. executor officii incipiat antiphonam} Salve. \emph{conversus ad reliquias quam prosequatur chorus cum genuflexione osculando terram} \emph{ab ipso quoque executore officii primo cum flectione. Senior genuflectendo dicat sic.}\footnote{`\emph{primo cum choro genufiectendo, dicatur sic}', 1882:50.}
...
\emph{Peracta hac\footnote{`\emph{autem}', 1882:52.} statione eat processio per medium claustri a dextera manu usque ad hostium ecclesie occidentale, cantando {[}hanc{]}} \emph{antiphonam {[}sequentem{]}} \emph{cantore incipiente hoc modo.}
...
¶ \emph{{[}Finito versu,{]}} \emph{duo dyaconi de secunda forma {[}indutis{]}} \emph{in cappis nigris stantes ad gradum {[}chori{]}\footnote{1555, unpaged.} conversi ad altare simul dicant sic.}\footnote{`\emph{habitu non mutato, sparsim stantes simul dicant}', 1882:69. 1517---Duo diaconi de ii. forma stantes ad gradum chori conversi ad altare simul dicant. {[}1882:69.{]} `\emph{simul incipiant hoc modo sequentur}', 1523:64v.}
...
\emph{{[}Item predicti duo{]}} \emph{sacerdotes dicat {[}istas{]}\footnote{1882:73.} iij. antiphonas sequentes {[}genuflectendo continue.{]}}
...
\emph{Hic mittat cereum in medio}\footnote{`\emph{infra}', 1882:89.} \emph{fontis crucem faciens, {[}et postea prosequatur{]}.}\footnote{1523:85r. `\emph{dicendo hoc quod sequitur hoc modo}', 1882:89. 1519:85r. has after faciens `\emph{\&c.}'}

Score000

\emph{Hic extrahatur cereus a}\footnote{`\emph{extra}', 1882:89.} \emph{fontes dicendo {[}sic{]}.}\footnote{1882:89.}
...
\emph{Et hoc modo dicatur totus psalmus cum} Glória Patri. \emph{et} Sicut erat. \emph{{[}cum{]}\footnote{1882:97.} uno} Allelúya. \emph{tantum}\footnote{`\emph{tamen}', 1882:97.} \emph{post unumquemque versum \&c.}
...
\emph{Clerici {[}cantent versum{]}.}\footnote{1882:118.} Score000
...
\emph{{[}Postea{]}\footnote{1882:118.} clerici {[}dicant versum{]}.}\footnote{1882:118.} Score000
...
\emph{{[}Postea{]}\footnote{1882:119.} clerici {[}dicant versum{]}.}\footnote{1882:119.} Score000

\emph{{[}Postea{]}\footnote{1882:119.} chorus {[}repetat{]}}\footnote{1882:119.} Kýrie.

\emph{{[}Item{]}\footnote{1882:119.} clerici {[}versum{]}.}\footnote{1882:119.} Score000
...
\emph{{[}Deinde{]}\footnote{1882:119.} clerici {[}dicant versum{]}.}\footnote{1882:119.} Score000
...
\emph{{[}Deinde{]}\footnote{1882:119.} clerici {[}versum{]}.}\footnote{1882:119.} Score000
...
\emph{Et clerici predicti prosequantur de ceteris ordinibus quantum sufficit {[}iter{]}\footnote{1882:119.} {[}usque ad gradum chori{]}},\footnote{1517. {[}1882:119.{]}} \emph{usque ad} Omnes Sancti. \emph{{[}et cetera.{]}}\footnote{1882:119. Rylands-24:232. includes another litany here, Rex Kyrie. See the appendix.}
...
\emph{Ante iij. aspergatur aqua benedicta~: et post aspersionem aque} \emph{ordinetur processio sine vexillis et sine reliquiis~: circumeundo ecclesiam et claustrum sicut in die pasche~: et cantetur prosa sequens in medio processionis a tribus clericis de superiori gradu in cappis sericis {[}qui{]}\footnote{1882:124.} dicant hoc modo.}
...
\emph{Ordinetur {[}processio{]}\footnote{1882:125.} sicut in die natalis Domini. Sexta}\footnote{Note: `1517---Tertia.' 1882:125.} \emph{cantata eat processio per medium chori circumeundo claustrum cantore incipiente {[}hoc responsorium sequens{]}\footnote{1882:125.} hoc modo.}
...
\emph{In} \emph{tempore paschali {[}finiatur cum{]}.}
...
\emph{¶ Dominica vero infra octavas}\footnote{`\emph{et in octava}, MS.' 1882:135.} \emph{si dominica fuerit ad processionem Resp.} Terríbilis. 312. \emph{cum versu} Cumque evigilásset. \emph{ut supra et cum} Glória Patri. \emph{et {[}cum{]}}\footnote{1882:135.} ‡Et ego.\footnote{1882:135.
...
\emph{Ad primas vesperas in sabbato fiat processio ante crucem, nisi aliqua dominica omnino oporteat differri~: tunc memoria de dominica et de Trinitate non fiat, nec processio {[}In die eorum ante missam si dominica fuerit ad processionem{]}} \emph{℟.} In circúitu tuo. \emph{quere in communi plurimorum martyrum.} 396.
...
\emph{In redeundo {[}de{]}} \emph{sancta Maria.} 309.
...
\emph{Si dominica fuerit ad processionem {[}dicitur{]}} \emph{responsorium.}\footnote{1882:164.}
