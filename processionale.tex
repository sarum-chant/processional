...
\emph{Chorus vel organa respondeat cantum prose super litteram 𝔄. post unumquemque versum.}
...
\emph{℟.} Sancte Dei Precióse. 24. \emph{℣.} Ut tuo. \emph{et percantetur a toto choro~: tres diaconi dicant prosam} Te mundi. 25. \emph{Chorus 𝔄. et sic deinceps a toto choro.} Glória Patri. \emph{et dicatur hoc modo.}
...
1519:13v; AS:66; Ant-1519:70v; Brev-1531:34v.\footnote{1519:13v. has B-flat only at the second `𝔄.' 1519:13v. has `cleméntia' for `preséntia.' In 1519:13v. at the final cue `implévit' is set D.FF.DFDDC.}
...
1519:17r; Ant-1519:84r; Brev-1531:39r.\footnote{1519:17r. omits the flats and omits first note of the first `𝔄.' and `Martir in te' for `Martir vite.' In 1519:17r. `liberávit' begins on C. 1519:17r. has `sede', not `cede' and `rósea' for `rúbea' and `in te donátum' not `vite donátus.'}
